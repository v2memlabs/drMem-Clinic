...
import '../../shared/widgets/coming_soon_action.dart';
...
class _MessageSendScreenState extends State<MessageSendScreen> {
  ...
  Future<void> saveAsSent() async {
    ...
    final msg = SentMessage(
      ...
      channel: channel,
      category: category,
      templateTitle: template?.title ?? 'Manuel',
      sentAt: DateTime.now(),
      sentBy: sentBy,
                        ...
                        children: [
                          ...
                          FormSectionCard(
                            ...
                            children: [
                              ...
                              const ComingSoonOutlinedButton(label: 'Önizle'),
                            ],
                          ),
                        ],
                      ),
