...
abstract final class SurgeryProcedureNoteRepositoryBackendGate {
  static bool shouldUseRemoteSurgeryProcedureNotes({
    ...
    if (!OperationalRecordsRemoteCapabilities.surgeryProcedureNotesTableReady) {
      return false;
    }
