-- =============================================================================
-- Settings User Invitation v2d — Deep-link accept (membership_id in redirect)
-- =============================================================================

-- -----------------------------------------------------------------------------
-- bootstrap_tenant_invited_user_v2 — optional pre-assigned membership id (EF)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- accept_my_tenant_invitation_v2 — deep-link audit source v2d
-- -----------------------------------------------------------------------------
...
begin
  ...
  v_audit_source := case
    when p_membership_id is not null then 'settings_invitation_v2d'
    else 'settings_invitation_v2a'
  end;
...
grant execute on function public.bootstrap_tenant_invited_user_v2(uuid, text, text, text, uuid) to authenticated;
